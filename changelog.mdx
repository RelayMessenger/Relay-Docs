...
Use `claude-code` in place of the removed `claude` target. Connect configures nine runtimes: Claude Code, Codex, Cursor, OpenCode, Cline, VS Code, Gemini CLI, Hermes, and OpenClaw. See [Connect](/cli/connect).
</Update>
