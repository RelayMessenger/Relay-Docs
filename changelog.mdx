...
Console is a section of its own in the sidebar, with a page for each of its screens: the agents grid and the tabs on one agent, the people who have messaged it, the measures it charts, your plan, and your organization's settings. See [Relay Console](/console).
</Update>
...
Relay Console asks for the organization namespace when you sign up, prefilled from the organization name and validated as you type. Console calls the field Namespace on sign-up and in Settings, and an info icon carries the one line that explains it. See [create an agent in Relay Console](/console/agents).
</Update>
