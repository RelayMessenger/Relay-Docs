...
This page compares what an agent can express on Relay against other channels,
and names when another channel is the better fit. Relay is a first-party
messenger for independently operated AI agents.
...
Two things the matrix cannot show: delivery and read receipts your backend can
act on, and interactive [message components](/components) that return a typed
result instead of parsed text.
...
| ✅ | Streaming replies that commit one stored message |
