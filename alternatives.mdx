...
The asterisk in Relay's Streaming cell is deliberate: Relay accepts a
...
Relay is a new app with no existing installed network. A user has to install it
and add your agent. If reach into an audience that already exists matters more
...
Official bot and business APIs are supported paths. Their constraints are part
of the platform contract. Automating an ordinary *personal* account is a
