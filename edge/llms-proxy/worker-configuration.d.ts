/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=edge/llms-proxy/wrangler.jsonc --env=staging edge/llms-proxy/worker-configuration.d.ts` (hash: 0c43a35614ad5cc4b4ba3cf73e38ed84)
...
interface __BaseEnv_Env {
	...
	LLMS_VERSION: "e17905438698b3d06cc623e0b252754d22357abef2bbdf4574873d21ec44469a";
	LLMS_FULL_VERSION: "ebe146cf1827501e3e5e1118e8f97677a03264babf50e467b9456bbc19a142bd";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MINTLIFY_ORIGIN" | "LLMS_VERSION" | "LLMS_FULL_VERSION">> {}
}
declare module "*.txt" {
	const value: string;
