/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=edge/llms-proxy/wrangler.jsonc --env=staging edge/llms-proxy/worker-configuration.d.ts` (hash: b55411e9ae410224c22d356c00bf3ba2)
...
interface __BaseEnv_Env {
	...
	PROXY_TAG: "cloudflare-staging";
	LLMS_VERSION: "67b97b0657e01fd74cb4ccb9e48a1387f195575f0bef59f33a997649eb5470f1";
	LLMS_FULL_VERSION: "03414867d5120538e105be700ccc1a5644f581af1f83c083fcbbb69c7bb5daf7";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MINTLIFY_ORIGIN" | "PROXY_TAG" | "LLMS_VERSION" | "LLMS_FULL_VERSION">> {}
}
declare module "*.txt" {
	const value: string;
