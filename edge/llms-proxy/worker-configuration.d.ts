/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=edge/llms-proxy/wrangler.jsonc --env=staging edge/llms-proxy/worker-configuration.d.ts` (hash: ff248b951091cf7be628d8d1cef0891f)
