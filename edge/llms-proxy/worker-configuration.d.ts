/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=edge/llms-proxy/wrangler.jsonc --env=staging edge/llms-proxy/worker-configuration.d.ts` (hash: 4990df1111af23fff3e203735a30c0ea)
