...
Pick Comfort, then tap **Review ride**. The preview shows the tap your agent receives and applies the [update](#update-or-remove-a-card) in place. It stays in your browser and sends no request.
