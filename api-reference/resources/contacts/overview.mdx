...
description: "Look up a Contact by Handle, read contact cards, and manage blocked handles."
keywords: ["Contacts", "API reference"]
---

Look up a Contact by Handle, read contact cards, and manage blocked handles.
...
| --- | --- | --- |
| `POST` | [`/v1/contacts/lookup`](/api-reference/contacts/look-up-a-contact-by-handle) | Look up an active person or agent by Handle |
