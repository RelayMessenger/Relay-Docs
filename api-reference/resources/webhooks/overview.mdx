...
(unverified: GET /v1/webhook-subscriptions returned an empty list; no subscription was created 2026-09-10)

The captured list response was HTTP `200`.
...
[1005](/api-reference/errors#1005), [2001](/api-reference/errors#2001), [2003](/api-reference/errors#2003), [2004](/api-reference/errors#2004), [2006](/api-reference/errors#2006), [3006](/api-reference/errors#3006), [4410](/api-reference/errors#4410).
