...
| `display_name` | string or null | Display name for the chat. Null for a group that has not been named; a direct chat defaults to the other participant's handle. Can be updated for group chats. |
