...
A link part renders a card with the page's title and image. A [URL button](/interactive-components/buttons#send-a-url-button) renders a label that opens the page when tapped.
