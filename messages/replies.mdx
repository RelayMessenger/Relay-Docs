...
<Tabs>
  <Tab title="Preview">
    <ChatPreview scene="replies" label="A reply quoting the person's photo; tap the quote to jump to it" json={{"message": {"parts": [{"type": "text", "value": "That image looks correct."}], "reply_to": {"message_id": "01993d50-b4ce-71e6-8e65-35d325d95ddb", "part_index": 1}}}} />
  </Tab>
  <Tab title="JSON">
    ```json
    {
