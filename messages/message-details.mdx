...
| `is_system_message` | `true` for a chat event such as a participant joining or a call ending |
| `system_event` | [Event type and fields](/api-reference/resources/messages/overview#system-events), including `call` and its current call state |
