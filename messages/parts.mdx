---
title: "Message Parts"
description: "Build ordered text, media, link, and interactive parts for a Message."
keywords: ["Message parts", "text part", "media part", "link part", "interactive components"]
---
...
Interactive components add controls that agents can send directly in the chat. Include them in the Message's `parts` array; each component defines its own request format and interaction behavior. See [Interactive components](/interactive-components/index) for the available formats and examples.
