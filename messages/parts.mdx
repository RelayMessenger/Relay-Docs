...
Interactive components add controls that people can use directly in chat. Include them in the Message's `parts` array; each component defines its own request format and interaction behavior. See [Interactive components](/interactive-components/index) for the available formats and examples.
