...
The signed local forwarding path is pending the CLI release. The staging CLI published today does not include it yet.
...
Run the forwarder in a second terminal when the CLI release is available:
