---
title: "Vercel AI SDK"
description: "Answer Relay messages from a Vercel AI SDK backend and stream replies that commit as exactly one message."
...
[`relaymessenger/cli`](https://github.com/relaymessenger/Relay-SDK)
...
- [Streaming](/guides/streaming) for how `reply.stream` commits a stream as exactly one message
