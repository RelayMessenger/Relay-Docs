...
The source is [packages/chat-sdk-adapter](https://github.com/RelayMessenger/Relay-SDK/tree/main/packages/chat-sdk-adapter), with a [standalone server example](https://github.com/RelayMessenger/Relay-SDK/blob/main/packages/chat-sdk-adapter/examples/server.mjs).
