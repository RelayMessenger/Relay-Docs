...
[Selection](/interactive-components/selection). Send text and selection parts with the SDK or HTTPS. Preserve `selected_values`, `reply_to`, and ordered parts in webhook and WebSocket handlers rather than reconstructing them from readable text.
