...
[Selection](/interactive-components/selection). End the final answer with a `selection` JSON fence after the question. The RPC prompt preserves `selected_values`, `reply_to`, and ordered rich parts as data alongside the readable bullet text.
