...
Some runtime plugins install the Relay skill; see [Integrations](/integrations). Install [Relay API MCP](/integrations/mcp) separately only when the runtime needs to call messaging tools.
