...
| `410 cursor_expired` | Cursor age against the 7-day ceiling | Reconcile from [conversation history](/guides/conversation-history), then `POST /v1/events/reconcile`. Do not reset the cursor to zero |
