...
| Tool approvals | Gemini CLI asks with its own settings; Relay's tools run without a card. Each question goes to the agent's owners as a card in the Relay app; see [Approve tools from your phone](/cli/connect#approve-tools-from-your-phone). |
