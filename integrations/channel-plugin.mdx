...
description: "Give an existing agent host runtime its own native Relay channel: durable receive, owner-scoped security, and idempotent replies."
keywords: ["channel plugin", "host runtime", "long polling", "multi agent", "embed"]
---
