...
| Tool approvals | OpenCode asks with its own settings. Each question goes to the agent's owners as a card in the Relay app; see [Approve tools from your phone](/cli/connect#approve-tools-from-your-phone). |
