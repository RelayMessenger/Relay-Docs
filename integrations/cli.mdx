...
| --- | --- |
| Only the pinned owner can create prompts or answer approval requests, which arrive as messages with one-tap reply suggestions | A non-owner message is dropped before its content is interpreted |
