...
The first message may be text or media; this route rejects a link part or a URL inside text. To open a group with a link, [send to the handles](/concepts/messages/send#resolve-or-create-a-chat) instead. Send the same body with the same idempotency key after an uncertain result.
