...
keywords: ["location", "location sharing", "requestLocation", "getLocation", "GeoJSON", "location.sharing.started", "location.sharing.stopped"]
---
...
<Tabs>
  <Tab title="Preview">
    <ChatPreview scene="location" label="The location request card; tap Share My Location" json={{"success": true, "message": "Location request sent"}} />
  </Tab>
  <Tab title="JSON">
    ```json
...
The chat gets a message from your agent with a **Share My Location** button. The person chooses **For One Hour**, **Until End of Day**, or **Indefinitely**, and can stop at any time.
