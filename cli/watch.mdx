...
```bash
npx relaymessenger@0.1.6-staging.53 watch
```
...
Captured with `relaymessenger@0.1.6-staging.53`. Help output describes the command; it does not prove a live reply.
