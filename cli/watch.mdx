...
```bash
npx relaymessenger@0.1.6-staging.45 watch
```
...
Captured with `relaymessenger@0.1.6-staging.45`. Help output describes the command; it does not prove a live reply.
