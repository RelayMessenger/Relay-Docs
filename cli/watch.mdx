...
```bash
npx relaymessenger@0.1.11-staging.2 watch
```
...
Captured with `relaymessenger@0.1.11-staging.2`. Help output describes the command; it does not prove a live reply.
