...
```bash
npx relaymessenger@0.1.6-staging.44 watch
```
...
Captured with `relaymessenger@0.1.6-staging.44`. Help output describes the command; it does not prove a live reply.
