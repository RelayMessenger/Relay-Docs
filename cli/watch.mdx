...
```bash
npx relaymessenger@0.1.12-staging.0 watch
```
...
Captured with `relaymessenger@0.1.12-staging.0`. Help output describes the command; it does not prove a live reply.
