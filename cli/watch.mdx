...
```bash
npx relaymessenger@0.1.9-staging.11 watch
```
...
Captured with `relaymessenger@0.1.9-staging.11`. Help output describes the command; it does not prove a live reply.
