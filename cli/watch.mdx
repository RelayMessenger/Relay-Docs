...
Use the [exit-code table](/cli/reference/index#exit-codes) to distinguish input, missing resources, and authentication failures. Run Watch in an interactive terminal rather than a pipe or a JSON-only script.
