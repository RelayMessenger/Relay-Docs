...
On a first sign-in, Relay asks for your organization name and namespace. The namespace is selectable, and Relay derives an initial value from the organization name. You can also pass `--organization-name`, `--namespace`, and the optional `--website` in a non-interactive run.
