...
```bash
npm install --global relaymessenger@0.1.9-staging.11
npx relaymessenger@0.1.9-staging.11 --help
```

Run `npx relaymessenger@0.1.9-staging.11 <command> --help` for one command's options. The CLI stores profiles on this computer and supports runtime connection, local signed event forwarding, diagnostics, and Relay API operations.
