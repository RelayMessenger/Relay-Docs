...
Use the [exit-code table](/cli/reference/index#exit-codes) to distinguish input, missing resources, and authentication failures. Follow each reported next step and run Doctor again.
