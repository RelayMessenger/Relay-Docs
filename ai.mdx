...
This page gives a coding agent everything it needs to integrate Relay without
reading the site: docs as Markdown, the whole site as one file, the API as
OpenAPI, an MCP server, an installable skill, and a paste-ready brief.
