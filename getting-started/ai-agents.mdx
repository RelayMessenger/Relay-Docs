...
| File | Use |
| --- | --- |
| `https://docs.relayapp.im/llms.txt` | Agent onboarding instructions and page index |
...
Connect my Relay agent @<agent-handle> following https://docs.relayapp.im/llms.txt.
