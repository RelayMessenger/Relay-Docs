...
Use the [Skills](/integrations/skills), [Codex](/integrations/codex), or
[Cursor](/integrations/cursor) integrations for packaged guidance. Use
[MCP](/integrations/mcp) when a trusted local MCP client should call Relay
