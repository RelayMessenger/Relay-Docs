...
one subscription is saved. With zero saved subscriptions, Relay queues events
for WebSocket delivery. The `event_id` remains stable when pending events move
between these paths.
