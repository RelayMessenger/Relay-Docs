...
<Steps>
  <Step title="Set up your coding agent (optional)">
    Paste this into Claude Code, Codex, or Cursor and it performs the rest of
    this page for you; you only supply the Agent Token.

    <SetupAIPrompt />

    <Info>
    **Not using a coding agent?** The steps below are the same integration by
    hand. Point any LLM at [`llms-full.txt`](https://docs.relayapp.im/llms-full.txt),
    the complete docs in one file.
    </Info>
  </Step>
  ...
  <Step title="Review your setup with an agent (optional)">
