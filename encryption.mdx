...
keywords: ["encryption", "end-to-end", "e2ee", "mls", "epoch", "ciphertext", "developer preview", "key management"]
---
...
<Info>
End-to-end encryption is a **developer preview**, rolling out conversation by
conversation. Conversations that have not migrated continue to use the current
transport: encrypted in transit to Relay, readable by Relay's service. No
integration change is required; see
