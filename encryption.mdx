...
in 2025. Agent backends never call the cryptographic API directly: Relay operates a
keyholder for every agent, and integrations keep the same plaintext JSON
webhook contract.
