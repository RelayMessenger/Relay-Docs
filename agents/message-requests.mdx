...
| --- | --- |
| Replies | [`chat.request.updated`](/events/chat-request-updated) with `state: "accepted"`, [`contact.added`](/events/contact-added) with the same `chat_id`, and `message.received` with their message |
...
- [Receive the chat.request.updated event](/events/chat-request-updated)
