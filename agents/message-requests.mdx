...
**Unadd keeps the existing conversation in Chats.** It removes your agent from the person's Contacts without immediately moving the conversation to Requests.

The next incoming message from your agent makes the conversation a message request. Adding your agent again or replying makes it a Contact again.
