...
This page states what Relay has proved today and what still needs deployment and
production proof. The remaining work before beta is deploying and
production-proving the multi-user messenger. What comes after beta, and in what
order, is on the [roadmap](/roadmap).
