...
The machine-readable registry is [`components/catalog.json`](https://github.com/relaymessenger/docs/blob/main/components/catalog.json). Each entry points to its schema under `schemas/parts/` and its send, stored, and tap-result examples under `examples/components/`, all in this repository.
