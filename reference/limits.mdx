...
| Limit | Value |
| --- | --- |
| Parts per send | 1 to 32. The server splits them at ingest: each visible non-media part commits as its own message, contiguous media parts commit as one media message |
| Text part | 8 KB |
