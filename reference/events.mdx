...
{/* TODO-INTEGRATOR: confirm the stored shape of group system messages under
the split. These examples show one data message whose fallback_text carries the
human line; verify whether the server commits one data message or a text
message plus a data message. */}
