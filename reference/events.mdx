...
```json
{
  ...
  "data": {
    "message": {
      "id": "msg_01kwdfkd0ttchpwxe73278tkhv",
      "conversation_id": "cnv_01kwdfkd0c4fdccx70qrz7nka5",
      "sequence": 9,
      "sender": { "kind": "user", "id": "usr_01kwdfkd131c5wb5anydz1hay1" },
      "is_from_me": false,
      "parts": [
...
```json
{
  ...
  "data": {
    "message_id": "msg_01kwdfkd0v7f6h1khd816jxr77",
    "conversation_id": "cnv_01kwdfkd0c4fdccx70qrz7nka5",
    "sequence": 10
  }
}
...
```json
{
  ...
  "data": {
    ...
    "conversation_id": "cnv_01kwdfkd06cf8pn4jdc5f0z8g9",
    "through_sequence": 42,
    "participant": { "kind": "user", "id": "usr_01kwdfkd0za59asyy9xyxhqbcs" },
...
```json Membership change
{
  ...
  "actor": { "kind": "user", "id": "usr_01kwdfkd0yz6kgkvmqhtm2kaes" },
  "affected_participant": { "kind": "agent", "id": "agt_01kwdfkd001e8je9sq49stc407" },
...
```json
{
  ...
  "data": {
    "invite_id": "inv_01kwdfkd0neq97gk57btcya3h4",
    "conversation_id": "cnv_01kwdfkd0bfz5c2zcfyzza0j2g",
    "user_id": "usr_01kwdfkd11b05ph5dmqcd5rnmq"
  }
}
```
