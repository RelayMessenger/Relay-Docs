...
| `cursor_expired` | 410 | The poll cursor fell behind the seven-day event retention. Reconcile from [conversation history](/guides/conversation-history); do not reset to zero. |
