...
<Info>
[End-to-end encryption](/encryption) is a developer preview rolling out
conversation by conversation. In a migrated conversation Relay stores sealed
messages, and [who can decrypt them depends on your key-management
tier](/guides/agent-key-management). Everything below describes conversations
on the current transport, which remains the default.
</Info>
