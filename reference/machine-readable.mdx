...
contiguous media parts commit together as one media message. Each bubble is a
message. reply_to targets a message id only:
...
- Reactions: POST /v1/messages/{id}/reactions
  { "operation": "add"|"remove", "type": "emoji", "emoji" }
