...
Body: { "conversation_id": "cnv_…", "parts": [...], "reply_to"?: { "message_id" } }
...
targets a message id only and projects on the first committed message; a group
invocation is delivered on the last one's message.received event:
