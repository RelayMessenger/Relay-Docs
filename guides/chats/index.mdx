...
A user client archive-deletes a conversation with its user-session bearer
credential:
...
Relay returns `204` for an allowed request. It returns `409` while the Chat is
direct and its active peer is currently a default agent.
