...
```bash
curl -sS -X POST \
  "$RELAY_API_URL/v1/messages?stream=true&conversation_id=cnv_01kwdfkd05sfmqfr8p51egymg1&invocation_id=ivk_01k1m4q9vn2r7t9b4c6qdh8xwy" \
  -H "Authorization: Bearer $RELAY_AGENT_TOKEN" \
  -H "Idempotency-Key: reply-evt_01kwdfkd0dj78sz00y0nv0dhtz" \
...
curl -sS -X POST "$RELAY_API_URL/v1/groups/invites" \
  ...
  -d '{
    ...
    "user_ids": ["usr_01kwdfkd11b05ph5dmqcd5rnmq", "usr_01kwdfkd12b1vg1y9yj60s26hy"],
