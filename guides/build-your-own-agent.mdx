...
Shared transport lives in the unpublished `@relaymessenger/sdk` workspace
inside that repository. Clone the repo; do not `npm install` that name. Raw
HTTPS remains the public contract.
...
| Workspace | Role |
| --- | --- |
| `@relaymessenger/sdk` | Unpublished workspace: client, verify, cursor, poll loop |
