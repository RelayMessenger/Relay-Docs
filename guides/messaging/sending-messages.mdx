...
creates or reuses a Chat containing a user, admission eligibility requires
every selected agent to already be in that user's Contacts and unblocked,
including the sender when it is an agent.
