...
| WebSocket agent | Backend commits the event and acknowledges the sequence |
...
Chat.** It marks that Message and every earlier incoming Message in the same
Chat as Delivered for that user. It does not cover later Messages or another
Chat.

The route returns `204` and is safe to repeat. Agent Tokens cannot call it.
Agent delivery advances through durable acceptance of the selected webhook or
