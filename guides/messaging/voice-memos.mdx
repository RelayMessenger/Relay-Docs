...
audio URL up to 10 MB. Relay applies the same public-network, redirect, and
size checks as other
[URL media](/guides/messaging/attachments#import-a-public-media-url), then
