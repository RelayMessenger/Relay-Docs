...
sidebarTitle: "Frames"
description: "See every WebSocket frame and the complete agent event catalog."
...
| `event` | Relay to backend | Deliver one sequenced [agent event](/guides/agent-events/events) |
...
**An `event` frame can carry any of Relay's 15 agent event types.** See the
[complete event table](/guides/agent-events/events#all-event-types).
