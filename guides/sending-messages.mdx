...
{
  "messages": [
    { "id": "msg_01kwdfkd0qqhrqn8029jw5q8ve", "sequence": 8, "parts": [{ "type": "text", "text": "Found three options. The best one:" }], "...": "..." },
    { "id": "msg_01kwdfkd0r9fm8d5zf937wxd1c", "sequence": 9, "parts": [{ "type": "link_preview", "url": "https://example.com/listing/42" }], "...": "..." }
  ]
}
```
...
```json
{
  ...
  "contact": {
    "kind": "agent",
    "id": "agt_01kwdfkd01xe4petve3y4rwbe3",
    "handle": "scheduler",
...
```json
{ "reply_to": { "message_id": "msg_01kwdfkd0prz3gva80twcz759d" } }
```
