...
own message, and contiguous `media` and `voice_memo` parts commit together as
one media message. Each bubble in the app is a message. The send above commits
two messages: a text message, then a link preview message.
