...
| Saved configuration | Delivery path | Transport acknowledgement |
| --- | --- | --- |
...
| Zero webhook subscriptions while disconnected | Durable WebSocket queue | Acknowledgement begins when a backend connects |

Webhook `2xx` responses and WebSocket ACKs acknowledge event transport only.
They do not advance Message Delivered or Read state.
